...
Fast JPEG-like color compressor (vectorized DCT + 4:2:0 chroma subsampling).

Usage:
    python fast_jpeg_color.py input.jpg output.png --quality 50

Requires:
    pip install numpy pillow scipy

Notes:
 - Quality is 1..100 like JPEG (lower -> stronger quantization -> more compression/loss).
 - This script performs DCT/quantize/dequantize/IDCT in a vectorized manner for speed.
"""
import os
import time
import sys
...
def compress_reconstruct_color(image_path, output_path, quality=50, do_timing=True):
    ...
    # PSNR computed against original
...
if __name__ == "__main__":
    # ✅ Just change these filenames to your own
    input_image = "input.jpg"        # your input file (must exist)
    output_image = "output.jpg"     # your output file
    quality = 10                    # 1..100 (higher = better quality)
